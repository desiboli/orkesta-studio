...
function ScrollVelocityRowImpl({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We want to update the sizes when the container or block changes
  useEffect(() => {
    ...
    >
      ...
      >
        {Array.from({ length: numCopies }).map((_, i) => (
          <div
            // biome-ignore lint/suspicious/noArrayIndexKey: {i} is a valid key
            key={i}
